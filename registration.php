    ...
    if ($isValid) {
            ...
            if ($stmt->execute()) {
                ...
                try {
                    ...
                    $mail->setFrom('jonwilyammayormita@gmail.com', 'FairShare Website');
                    $mail->addAddress($email, "$firstName $lastName");

                    // Email subject and body content
                    $mail->isHTML(true);
                    $mail->Subject = 'Welcome to FairShare!';
                    $mail->Body = "
                    <html>
                    <head>
                    ...
                    <body>
                        ...
                        <p>Thank you for registering. Please proceed to login by clicking the link below:</p>
                      <p><a href='http://localhost/Rizee/Login.php?code=$verificationCode'>Login Page</a></p>
...
?>
    ...
    <form method="post" action="">
        <h2>Register to Fair<span>Share</span></h2>
